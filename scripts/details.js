...
document.getElementById('detail-container').innerHTML =
    `<div class="detail-card d-flex flex-column flex-lg-row justify-content-center justify-content-lg-center align-items-center 
            gap-5 border border-dark border-1">
        <div class="col-10 col-sm-6 col-md-6 col-lg-5 col-xl-5 col-xxl-5 detail-img-container border border-dark border-1">
    ...
    <div class="fs-4 justify-selft"><a href="${document.referrer}">Volver</a></div>`