...
//Filtra los eventos con fecha futura.
...
//Inicializa la página con los eventos futuros.
...
let filters = {
    'searchStr': '',
    'selectedCategories': [],
    'filteredEvents': upcomingEvents //Por defecto contiene los eventos futuros.
};
...
const applyFilters = () => {
    if (selectedCategories.length > 0) {
        const res = upcomingEvents.filter(evento => selectedCategories.includes(evento.category))
        filteredEvents = res;
    } else {
